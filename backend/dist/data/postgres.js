...
export async function initializePostgresPool() {
    ...
    try {
        ...
        const existingProducts = await createdPool.query('select count(*)::text as count from app_products');
        ...
        const existingSuppliers = await createdPool.query('select count(*)::text as count from app_suppliers');
